...
// Persistencia LOCAL: la sesión sobrevive a cerrar la app/pestaña indefinidamente.
...
function showScreen(id, productoId) {
  // Eliminar el loader de arranque la primera vez que se muestra una pantalla real.
